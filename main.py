...
def api_all_keys():
    ...
    return jsonify({'success': True, 'keys': [{'name': k.name, 'key': k.key, 'used': k.is_used, 'expires': k.expires_date.strftime('%Y-%m-%d')} for k in keys]})
